...
readonly OPENCORE_VERSION="0.7.8"
readonly KEXT_APPLEALC_VERSION="1.6.9"
readonly KEXT_INTELMAUSI_VERSION="1.0.7"
readonly KEXT_LILU_VERSION="1.6.0"
readonly KEXT_VIRTUALSMC_VERSION="1.2.8"
readonly KEXT_WHATEVERGREEN_VERSION="1.5.7"
