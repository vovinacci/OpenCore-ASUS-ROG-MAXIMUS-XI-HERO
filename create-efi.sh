...
readonly OPENCORE_VERSION="0.7.2"
readonly KEXT_APPLEALC_VERSION="1.6.3"
readonly KEXT_INTELMAUSI_VERSION="1.0.7"
readonly KEXT_LILU_VERSION="1.5.5"
readonly KEXT_VIRTUALSMC_VERSION="1.2.6"
readonly KEXT_WHATEVERGREEN_VERSION="1.5.2"
